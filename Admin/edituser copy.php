...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->execute()) {
        // Check if status is set to 'verified'
        if ($status === 'verified') {
            ...
            $email_content->setFrom("marketing@pageantcentral.co", "Sagishi");
            $email_content->setSubject("Your account has been verified");
            $email_content->addTo($email, $firstmid_name . ' ' . $last_name);
            $email_content->addContent("text/plain", "Dear $firstmid_name, \n\nYour account has been verified. \nYou can log in to Sagishi at this link: \n https://sagishi.com/ ");
