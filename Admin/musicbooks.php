...
$posts_result = $conn->query("
    ...
    FROM posts p
    WHERE p.sub_category = 'Music, Books, Movies' AND p.status = 'published'
");
...
<head>
    ...
    <title>MUSIC, BOOKS, MOVIES SUBCATEGORY</title>
...
<body>
    <header>
        ...
        <div style="display:flex;">
            <h1 data-category="home-garden" style="color:white; margin-left:10px; font-weight:100;margin-bottom:auto;">MUSIC, BOOKS, MOVIES</h1>
