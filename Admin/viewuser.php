    ...
    <main>
       ...
       <div id="aboutme">
            ...
            <div class="row">
                ...
                <a href="edituser.php?id=<?php echo htmlspecialchars($user['user_id']); ?>"><button class="button-edit">Edit User</button></a>
                <a href="user_activities.php?id=<?php echo htmlspecialchars($user['user_id']); ?>"><button class="button-activities">User Activities</button></a>
            </div>
            <div class="row">
                <table>
                    <tr>
                    ...
                    <tr>
                        <th>Status:</th>
                        <td style="<?php echo $status_color; ?>"><?php echo htmlspecialchars($user['status']); ?></td>
                    </tr>
                    <tr>
                        <th>Email:</th>
