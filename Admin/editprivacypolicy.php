...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("UPDATE editpage SET content = ?, status = ?, description = ? WHERE id = 3");
    if ($stmt === false) {
    ...
    header("Location: viewprivacy.php");
    exit();
}
...
<header class="sticky-header">
    ...
    <div class="row" style="justify-content: left; width: 100%">
        <p style="color: #fff; font-size: 32px; margin-left: 10px; margin-bottom: 0px; font-wight:500;">Title: Privacy Policy</p>
    </div>
    <div class="row" style="justify-content: left; width: 100%">
        <hr class="navbar-divider2" style="border-radius: 40px; border: 1px solid #d90505; width:97% ;margin-bottom: 20px;">
    </div>
    <form method="POST" action="editprivacypolicy.php" enctype="multipart/form-data">
            <div class="row" style="justify-content: left; width: 100%">
                <!-- Replace textarea with CKEditor instance for description -->
                <textarea id="description" rows="4" name="description" style="width: 50%; margin-left: 10px; border-radius:10px;"><?php echo htmlspecialchars($description_3); ?></textarea>
            </div>
            <div class="row" style="justify-content: left; width: 15%; padding-top:10px; display: block; padding-bottom:10px; margin-left: 10px; margin-top: 10px; background-color:white;">
                ...
                <div class="row" style="width:100%; display: flex; margin-top: 10px;">
                    <label style="color: black; font-size: 16px; margin-right: auto; display: block;">
                        <input type="radio" name="status" value="disabled" <?php echo ($status_3 === 'disabled') ? 'checked' : ''; ?>> Disabled
                    </label>
                    <label style="color: black; font-size: 16px; display: block; margin-right: auto;">
                        <input type="radio" name="status" value="enabled" <?php echo ($status_3 === 'enabled') ? 'checked' : ''; ?>> Enabled
                    </label>
                </div>
            </div>
            ...
            <div class="row" style="justify-content: left; width: 100%; margin-top: 20px;">
                ...
                <textarea id="content" name="content" style="width: 97%; height:50vh;  margin-left: 10px;"><?php echo htmlspecialchars($content_3); ?></textarea>
            </div>
            ...
            <div class="row" style="width:100%; margin-top: 20px; display: flex; justify-content: left; margin-left: 10px;">
                ...
                <button type="button" onclick="window.location.href='viewcontactus.php'" class="button button-cancel">Cancel</button>
            </div>
    </form>
