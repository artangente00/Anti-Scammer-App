...
<body>
    <header>
        ...
        <div style="display:flex;">
            <h1 data-category="family" style="color:white; margin-left:10px; font-weight:100; margin-bottom:auto;">FAMILY</h1>
            <select id="subcategory-dropdown" style="margin-left:10px; height:25%; margin-top:auto;">
                ...
                <option value="Wedding Supplier">Wedding Supplier</option>
