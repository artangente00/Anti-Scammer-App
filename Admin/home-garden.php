...
<head>
    ...
    <title>HOME GARDEN CATEGORY</title>
...
<body>
    <header>
        ...
        <div style="display:flex;">
            <h1 data-category="home-garden" style="color:white; margin-left:10px; font-weight:100;margin-bottom:auto;">HOME & GARDEN</h1>
            <select id="subcategory-dropdown" style="margin-left:10px; height:25%; margin-top:auto;">
                <option value="">Select Subcategory</option>
                <option value="Furniture">Furniture</option>
                <option value="Kitchenware">Kitchenware</option>
                <option value="Gardening tools & Supplies">Gardening tools & Supplies</option>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function fetchPosts(category, subcategory) {
                ...
                let url = `/App/admin/get-posts.php?category=${category}`;
                if (subcategory) {
