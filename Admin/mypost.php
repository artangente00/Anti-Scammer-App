...
<body>
    ...
    <main>
        ...
        <div class="row" style="width: 100vw;">
            <div class="column" style="width: 25vw;">
                <!-- Edit Post Button -->
                <button class="edit-button" onclick="editPost()" style="width: 10vw; font-size:18px;background-color:transparent;color:red;">
                    <i class="fas fa-edit" style="font-size:20px; margin-right:3px; color:orange;"></i>Edit Post
                </button>
            </div>
            <div class="column" style="width: 25vw;">
                <!-- Publish Button -->
                <button class="publish-button" onclick="publishPost()" style="width: 10vw; font-size:18px;background-color:transparent;color:red;">
                    <i class="fas fa-upload" style="font-size:20px; margin-right:3px; color:orange;"></i> Publish
                </button>
            </div>
            <div class="column" style="width: 25vw;">
                <!-- Unpublish Button -->
                <button class="unpublish-button" onclick="unpublishPost()" style="width: 15vw;  font-size:18px;background-color:transparent;color:red;">
                    <i class="fas fa-eye-slash" style="font-size:20px; margin-right:3px;   color:orange;"></i> Unpublish
                </button>
            </div>
            <div class="column" style="width: 25vw;">
                <!-- Delete Button -->
                <button class="delete-button" onclick="deletePost()" style="width: 10vw; font-size:18px;background-color:transparent;color:red;">
                    <i class="fas fa-trash" style="font-size:20px; margin-right:3px; color:orange;"></i> Delete
                </button>
            </div>
        ...
        <div class="row" style="width: 100vw;">
            ...
            <div class="column">
                <div class="row" style="width: 30vw;">
                    <p class="post-author" style="color: white; margin-left: auto; "><?php echo htmlspecialchars($post['date_posted']); ?></p>
...
<div class="comments-section">
        ...
        <div class="row" style="width: 100vw;">
            <div class="comment" style="margin-right: auto; margin-left: 10px;">
                ...
                <button onclick="showReplyForm('<?php echo $comment_id; ?>')" style="margin-left: 60px; margine-bottom: 0px; background-color: transparent; color: white; border: none; cursor: pointer; padding: 5px 10px;">Reply to <?php echo $username_comment; ?></button>
                ...
                <?php if (!empty($replies)) : ?>
                    <div class="replies">
                        <?php foreach ($replies as $reply) : ?>
                            <p class="reply-text" style="color: white; font-size: 14px; margin-left: 70px; padding: 10px; width: 50vw; background-color: rgb(27, 23, 23);"><?php echo htmlspecialchars($reply['reply_text']); ?></p>
                            <p class="post-comment" style="margin-left: 0px; color: white; font-size: 12px; padding: 0px; width: 60vw; text-align: right;">
...
function publishPost() {
    var postId = <?php echo $post_id; ?>; // Assuming $post_id is already defined in your PHP code

    // Make an AJAX request to update the status of the post to 'published'
    $.ajax({
        url: 'publish_post.php', // Replace 'publish_post.php' with the actual URL of your PHP script
        method: 'POST',
        data: { postId: postId },
        success: function(response) {
            // Handle the success response
            alert('Post published successfully!');
            // You may also want to redirect the user to a different page after publishing the post
        },
...
function unpublishPost() {
    ...
    // Make an AJAX request to update the status of the post to 'unpublished'
    $.ajax({
        url: 'unpublish_post.php', // Replace 'unpublish_post.php' with the actual URL of your PHP script
        method: 'POST',
        data: { postId: postId },
        success: function(response) {
                // Handle the success response
        ...
        error: function(xhr, status, error) {
            // Handle the error
            alert('Error unpublishing post: ' + error);
        }
...
function deletePost() {
    ...
    // Make an AJAX request to update the status of the post to 'deleted'
    $.ajax({
        url: 'delete_post.php', // Replace 'delete_post.php' with the actual URL of your PHP script
        method: 'POST',
        data: { postId: postId },
        success: function(response) {
            // Handle the success response
            alert('Post deleted successfully!');
            // You may also want to redirect the user to a different page after deleting the post
        },
        error: function(xhr, status, error) {
            // Handle the error
