...
$posts_result = $conn->query("
    ...
    FROM posts p
    WHERE p.sub_category = 'Musical Instrument' AND p.status = 'published'
");
...
<head>
    ...
    <title>MUSICAL INSTRUMENT SUBCATEGORY</title>
    ...
    <header>
        ...
        <nav class="navbar">
            <div class="logo">
                ...
                <li><a href="homeusers.php" style="font-weight: 200;">HOME</a></li>
                    <?php if ($status_1 === 'enabled') : ?>
                        <li><a href="viewaboutus.php" style="font-weight: 200;">ABOUT</a></li>
                    <?php endif; ?>
                    <li><a href="users.php" style="font-weight: 200;">PROFILE</a></li>
                    <li><a href="scammersusers.php" style="font-weight: 200;">SCAMS</a></li>
                    <li><a href="modususers.php" style="font-weight: 200;">MODUS</a></li>
        ...
        <div style="display:flex;">
            <h1 data-category="home-garden" style="color:white; margin-left:10px; font-weight:100;margin-bottom:auto;">MUSICAL INSTRUMENT</h1>
