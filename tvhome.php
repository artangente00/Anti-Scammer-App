...
$posts_result = $conn->query("
    ...
    FROM posts p
    WHERE p.sub_category = 'TV & Home Theater' AND p.status = 'published'
");
...
<head>
    ...
    <title>TV & HOME THEATER SUBCATEGORY</title>
...
<body>
    <header>
        ...
        <div style="display:flex;">
            <h1 data-category="home-garden" style="color:white; margin-left:10px; font-weight:100;margin-bottom:auto;">TV & HOME THEATER</h1>
