...
$posts_result = $conn->query("
    ...
    FROM posts p
    WHERE p.sub_category = 'Investment' AND p.status = 'published'
");
...
<head>
    ...
    <title>INVESTMENT SUBCATEGORY</title>
...
<body>
    <header>
        ...
        <div style="display:flex;">
            <h1 data-category="home-garden" style="color:white; margin-left:10px; font-weight:100;margin-bottom:auto;">INVESTMENT</h1>
