...
$posts_result = $conn->query("
    ...
    FROM posts p
    WHERE p.sub_category = 'Health & Beauty' AND p.status = 'published'
");
...
<head>
    ...
    <title>HEALTH & BEAUTY SUBCATEGORY</title>
...
<body>
    <header>
        ...
        <div style="display:flex;">
            <h1 data-category="home-garden" style="color:white; margin-left:10px; font-weight:100;margin-bottom:auto;">HEALTH & BEAUTY</h1>
