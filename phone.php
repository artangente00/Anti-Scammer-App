...
$posts_result = $conn->query("
    ...
    FROM posts p
    WHERE p.sub_category = 'Phone' AND p.status = 'published'
");
...
<body>
    <header>
        ...
        <div style="display:flex;">
            <h1 data-category="home-garden" style="color:white; margin-left:10px; font-weight:100;margin-bottom:auto;">PHONE</h1>
