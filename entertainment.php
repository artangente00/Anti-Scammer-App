...
<body>
    <header>
        ...
        <div style="display:flex;">
            <h1 data-category="entertainment" style="color:white; margin-left:10px; font-weight:100; margin-bottom:auto;">ENTERTAINMENT</h1>
            <select id="subcategory-dropdown" style="margin-left:10px; height:25%; margin-top:auto;">
                ...
                <option value="Sing/Dance Competition">Sing/Dance Competition</option>
